...
<body>
    ...
    <div class="container">
        <div class="row">
            <form action="{{route('new_create_compte')}}" id="msform_facture" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="contenue">
                    ...
                    <div class="formulaire">
                        <div class="form mt-4" style="width:520px;">
                            <input name="email_resp_etp" autocomplete="off" id="email_resp_etp" type="email" required>
