...
ALTER TABLE pers_contact_urgences ADD relation_id bigint(20) UNSIGNED NOT NULL REFERENCES pers_relations(id) ON DELETE CASCADE;
...
ALTER TABLE pers_personne_a_charges ADD relation_id bigint(20) UNSIGNED NOT NULL REFERENCES pers_relations(id) ON DELETE CASCADE;

DROP TABLE IF EXISTS pers_historique_employers;
CREATE TABLE `pers_historique_employers`
(
    `ìd` bigint(20) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `employer_id` bigint(20) UNSIGNED NOT NULL REFERENCES employers(id) ON DELETE CASCADE,
    `ancien_fonction` VARCHAR(255) COLLATE utf8mb4_unicode_ci NOT NULL,
    `fonction_id` bigint(20) UNSIGNED REFERENCES fonctions(id) ON DELETE CASCADE,
    `evenement_id` bigint(20) UNSIGNED NOT NULL REFERENCES pers_evenements(id) ON DELETE CASCADE,
    `statut_emploi_id` bigint(20) UNSIGNED REFERENCES pers_statut_emplois(id) ON DELETE CASCADE,
    `categ_emploi_id` bigint(20) UNSIGNED REFERENCES pers_categorie_emplois(id) ON DELETE CASCADE,
    `dept_id` bigint(20) UNSIGNED REFERENCES departement_entreprises(id) ON DELETE CASCADE,
    `branche_id` bigint(20) UNSIGNED REFERENCES branches(id) ON DELETE CASCADE,
    `service_id` bigint(20) UNSIGNED REFERENCES services(id) ON DELETE CASCADE,
    `description_poste` VARCHAR(255) COLLATE utf8mb4_unicode_ci ,
    `date_changement_fonction` date NOT NULL
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci;


CREATE TABLE `pers_historique_sanctions` (
    `id` bigint(20) NOT NULL PRIMARY KEY AUTO_INCREMENT,
     `employer_id` bigint(20) UNSIGNED NOT NULL REFERENCES employers(id) ON DELETE CASCADE,
     `type` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL ,
      `description_id` bigint(20) UNSIGNED NOT NULL DEFAULT 1001 REFERENCES pers_mesure_administratives(id) ON DELETE CASCADE,
      `discipline_id` bigint(20) UNSIGNED NOT NULL DEFAULT 1001 REFERENCES pers_mesure_disciplinaires(id) ON DELETE CASCADE,
      `sanction_id` bigint(20) UNSIGNED NOT NULL REFERENCES pers_sanctions(id) ON DELETE CASCADE,
       `date_sanction` date NOT NULL DEFAULT current_timestamp(),
       `duree_sanction` int(4) NOT NULL,
       `supprimer` int(1) NOT NULL DEFAULT 0,
       `statut` int(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `pers_mesure_administratives` (`id`, `descriptions`, `created_at`, `updated_at`) VALUES ('1001', '-', current_timestamp(), current_timestamp());

INSERT INTO `pers_mesure_disciplinaires` (`id`, `nom_discipline`, `created_at`, `updated_at`) VALUES ('1001', '-', current_timestamp(), current_timestamp());
